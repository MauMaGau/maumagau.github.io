define(["agent"],
    ...
    // define the pu_reloadSpeed class as a copy of Agent
    var pu_reloadSpeed = Object.create(Agent);


    pu_reloadSpeed.init = function(pos){
        this.dir = 0;
        this.maxSpeed = 0.5;
        this.type = 'pu_reloadSpeed';
        this.target = require('game').Player;
        this.health = 1;
        this.effect = 'reloadSpeed';
        this.bonus = -5;
        this.color = '#0f0';
    ...
    pu_reloadSpeed.update = function(){
    ...
    pu_reloadSpeed.shoot = function(){
        Agent.shoot.call(this);
    }

    pu_reloadSpeed.hit = function(){
        return null;
    }

    pu_reloadSpeed.die = function(){
        var i = require('game').powerups.indexOf(this);
        require('game').powerups.splice(i, 1);
        Agent.die.call(this);
    }

    return pu_reloadSpeed;
});