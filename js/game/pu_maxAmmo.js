define(["agent"],
    ...
    // define the pu_maxAmmo class as a copy of Agent
    var pu_maxAmmo = Object.create(Agent);


    pu_maxAmmo.init = function(pos){
        this.dir = 0;
        this.maxSpeed = 0.5;
        this.type = 'pu_maxAmmo';
    ...
    pu_maxAmmo.shoot = function(){
        Agent.shoot.call(this);
    }

    pu_maxAmmo.hit = function(){
        return null;
    }

    pu_maxAmmo.die = function(){
